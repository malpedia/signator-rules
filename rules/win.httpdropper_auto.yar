rule win_httpdropper_auto {
    ...
    strings:
        $sequence_0 = { 014b18 c7437c00000000 897b70 85c0 0f85b4010000 }
            // n = 5, score = 200
            //   014b18               | jne                 0x6d
            //   c7437c00000000       | add                 ecx, ebx
            //   897b70               | imul                ecx, ecx, 0xea60
            //   85c0                 | inc                 esi
            //   0f85b4010000         | add                 ecx, ebx

        $sequence_1 = { 0110 80aa0110a4aa01 1023 d18a0688078a 46 }
            // n = 5, score = 200
            //   0110                 | cmp                 edi, 0x194
            //   80aa0110a4aa01       | jne                 0x21
            //   1023                 | add                 ecx, ecx
        ...
        $sequence_7 = { 895de4 8975f0 8975e8 e8???????? }
            // n = 4, score = 200
            //   895de4               | mov                 eax, 0x4849
            //   8975f0               | add                 ecx, ecx
            //   8975e8               | sub                 ebx, ecx
            //   e8????????           |                     
