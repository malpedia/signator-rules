rule win_gauss_auto {
    ...
    strings:
        ...
        $sequence_4 = { 56 e8???????? 8bb080000000 e8???????? 8b4c2408 898880000000 }
            // n = 6, score = 700
            //   56                   | push                esi
            //   e8????????           |                     
        ...
        $sequence_5 = { c7462000000000 c6461000 c7442410ffffffff 8bce e8???????? 8b4c2408 }
            // n = 6, score = 600
        ...
        $sequence_6 = { e8???????? c7442410ffffffff 8b4c2408 8bc6 5e 64890d00000000 }
            // n = 6, score = 600
            //   e8????????           |                     
            //   c7442410ffffffff     | mov                 dword ptr [esp + 0x10], 0xffffffff
            //   8b4c2408             | mov                 ecx, dword ptr [esp + 8]
        ...
        $sequence_7 = { e8???????? 51 56 8d4508 8bf1 50 8975f0 }
            // n = 7, score = 600
            //   e8????????           |                     
            //   51                   | push                ecx
            //   56                   | push                esi
        ...
        $sequence_8 = { 83661400 c7461807000000 6683660400 e8???????? }
            // n = 4, score = 600
        ...
        $sequence_10 = { eb18 85ff 7514 217e14 83f808 7205 }
            // n = 6, score = 600
            //   eb18                 | jmp                 0x1a
            //   85ff                 | test                edi, edi
            //   7514                 | jne                 0x16
        ...
        $sequence_11 = { 8bf0 395e14 57 7305 e8???????? 8b7e14 }
            // n = 6, score = 600
            //   8bf0                 | mov                 esi, eax
        ...
        $sequence_12 = { e8???????? cc 833e00 7505 e8???????? }
            // n = 5, score = 600
            //   e8????????           |                     
            //   cc                   | int3                
        ...
        $sequence_13 = { ff742408 8bf0 83661400 c7461807000000 }
            // n = 4, score = 600
        ...
        $sequence_14 = { 7205 8b4004 eb03 83c004 6683244800 }
            // n = 5, score = 600
            //   7205                 | jb                  7
        ...
        $sequence_15 = { 7205 8b7604 eb03 83c604 66832600 33c0 }
            // n = 6, score = 600
            //   7205                 | jb                  7
