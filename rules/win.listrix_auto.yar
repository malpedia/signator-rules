rule win_listrix_auto {
    ...
    meta:
        ...
        date = "2022-04-08"
        version = "1"
        description = "Describes win.listrix."
    ...
    strings:
        ...
        $sequence_2 = { e8???????? 83c414 8b9d90f5ffff 8d9594f5ffff }
            ...
            //   8d9594f5ffff         | lea                 edx, dword ptr [ebp - 0xa6c]
        ...
        $sequence_4 = { 0f84ac010000 8b1d???????? 68???????? 8d85c0f5ffff }
            ...
            //   8b1d????????         |                     
            //   68????????           |                     
            //   8d85c0f5ffff         | lea                 eax, dword ptr [ebp - 0xa40]
        ...
        $sequence_6 = { 68???????? 8d8dc0f5ffff 51 ffd3 }
            // n = 4, score = 100
            //   68????????           |                     
            //   8d8dc0f5ffff         | lea                 ecx, dword ptr [ebp - 0xa40]
            //   51                   | push                ecx
            //   ffd3                 | call                ebx
        ...
        $sequence_7 = { 6806020000 52 8d85eefbffff 50 668995ecfbffff e8???????? }
            ...
            //   52                   | push                edx
            //   8d85eefbffff         | lea                 eax, dword ptr [ebp - 0x412]
            //   50                   | push                eax
