rule win_babyshark_auto {
    ...
    meta:
        ...
        date = "2022-04-08"
        version = "1"
        description = "Describes win.babyshark."
    ...
    strings:
        ...
        $sequence_3 = { bf???????? f3ab 8d3452 895dfc c1e604 aa 8d9ec8674000 }
            ...
            //   8d3452               | lea                 esi, dword ptr [edx + edx*2]
            //   895dfc               | mov                 dword ptr [ebp - 4], ebx
            //   c1e604               | shl                 esi, 4
            //   aa                   | stosb               byte ptr es:[edi], al
            //   8d9ec8674000         | lea                 ebx, dword ptr [esi + 0x4067c8]
        ...
        $sequence_5 = { 8db6bc674000 bf???????? a5 a5 59 a3???????? }
            // n = 6, score = 100
            //   8db6bc674000         | lea                 esi, dword ptr [esi + 0x4067bc]
            //   bf????????           |                     
        ...
        $sequence_8 = { 5e 8d0c8dc8614000 3bc1 7304 3910 7402 }
            // n = 6, score = 100
            //   5e                   | pop                 esi
            //   8d0c8dc8614000       | lea                 ecx, dword ptr [ecx*4 + 0x4061c8]
            //   3bc1                 | cmp                 eax, ecx
            //   7304                 | jae                 6
