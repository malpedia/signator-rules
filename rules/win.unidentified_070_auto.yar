rule win_unidentified_070_auto {
    ...
    strings:
        ...
        $sequence_2 = { 6a00 6a04 50 ff15???????? 8945fc }
            // n = 5, score = 300
            //   6a00                 | push                0
            //   6a04                 | push                4
            //   50                   | push                eax
        ...
        $sequence_3 = { 6a00 6a00 6a00 6a04 50 ff15???????? 8945fc }
            // n = 7, score = 300
            //   6a00                 | push                0
            //   6a00                 | push                0
            //   6a00                 | push                0
        ...
        $sequence_4 = { 6a00 6a00 6a04 50 ff15???????? 8945fc 85c0 }
            // n = 7, score = 300
            //   6a00                 | push                0
            //   6a00                 | push                0
            //   6a04                 | push                4
        ...
        $sequence_7 = { 6a19 ff742418 c744243020000000 ff15???????? 85c0 }
            // n = 5, score = 200
            //   6a19                 | push                0x19
        ...
        $sequence_9 = { ff742460 ff15???????? 8b8c24dc040000 5f 5e 33cc }
            // n = 6, score = 200
            //   ff742460             | push                dword ptr [esp + 0x60]
            //   ff15????????         |                     
            //   8b8c24dc040000       | mov                 ecx, dword ptr [esp + 0x4dc]
            //   5f                   | pop                 edi
            //   5e                   | pop                 esi
            //   33cc                 | xor                 ecx, esp
