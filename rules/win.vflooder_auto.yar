rule win_vflooder_auto {
    ...
    strings:
        ...
        $sequence_2 = { 3b45f0 60 9c 8d642424 }
            // n = 4, score = 400
        ...
        $sequence_5 = { e9???????? ff742408 8f4500 60 }
            // n = 4, score = 400
            //   e9????????           |                     
        ...
        $sequence_6 = { 9c ff742404 8f4500 9c }
            // n = 4, score = 400
            //   9c                   | pushfd              
            //   ff742404             | push                dword ptr [esp + 4]
            //   8f4500               | pop                 dword ptr [ebp]
        ...
        $sequence_7 = { e8???????? 0000 43 7265 61 7465 }
            // n = 6, score = 400
            //   e8????????           |                     
            //   0000                 | add                 byte ptr [eax], al
            //   43                   | inc                 ebx
        ...
        $sequence_8 = { 9c 60 9c 9c 8d642430 }
            // n = 5, score = 400
            //   9c                   | pushfd              
            //   60                   | pushal              
            //   9c                   | pushfd              
