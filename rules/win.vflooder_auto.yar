rule win_vflooder_auto {
    ...
    strings:
        ...
        $sequence_1 = { 9c ff742404 8d642434 e9???????? }
            // n = 4, score = 400
            //   9c                   | pushfd              
        ...
        $sequence_3 = { 60 ff35???????? 8f442438 9c }
            // n = 4, score = 400
            //   60                   | pushal              
            //   ff35????????         |                     
        ...
        $sequence_5 = { 9c 60 9c 9c 8d642430 }
            // n = 5, score = 400
            //   9c                   | pushfd              
            //   60                   | pushal              
            //   9c                   | pushfd              
        ...
        $sequence_8 = { 3b45f0 60 9c 8d642424 }
            // n = 4, score = 400
