rule win_agent_btz_auto {
    ...
    strings:
        ...
        $sequence_2 = { 8d4c240c 51 ffd6 8d54240c 52 ffd7 }
            // n = 6, score = 2500
        ...
        $sequence_4 = { ff15???????? b803000f00 8b4df4 64890d00000000 5f 5e 5b }
            // n = 7, score = 2400
            //   ff15????????         |                     
        ...
        $sequence_5 = { 6a00 50 ff15???????? 894614 }
            // n = 4, score = 2300
            //   6a00                 | push                0
            //   50                   | push                eax
            //   ff15????????         |                     
        ...
        $sequence_10 = { 56 8bf1 8b4608 c706???????? 85c0 7413 }
            // n = 6, score = 2200
            //   56                   | push                esi
            //   8bf1                 | mov                 esi, ecx
        ...
        $sequence_11 = { c706???????? 85c0 7413 83f8ff 740e 50 ff15???????? }
            // n = 7, score = 2200
            //   c706????????         |                     
            //   85c0                 | test                eax, eax
            //   7413                 | je                  0x15
        ...
        $sequence_17 = { 0fb605???????? 66890d???????? 0fb60d???????? 660fafca }
            // n = 4, score = 1000
            //   0fb605????????       |                     
            //   66890d????????       |                     
            //   0fb60d????????       |                     
        ...
        $sequence_19 = { 6a01 e8???????? 50 e8???????? 83c41c }
            ...
            //   50                   | mov                 eax, 0xf0005
            //   e8????????           |                     
            //   83c41c               | mov                 ecx, dword ptr [ebp - 0xc]
        ...
        $sequence_21 = { 7511 e8???????? 83c020 50 e8???????? }
            // n = 5, score = 1000
            //   7511                 | push                0
            //   e8????????           |                     
            //   83c020               | push                0xa
        ...
        $sequence_22 = { c684241101000065 c684241201000074 c68424130100004c c684241401000061 c684241501000073 c684241601000074 c684241701000045 }
            // n = 7, score = 900
        ...
        $sequence_23 = { c684241501000073 c684241601000074 c684241701000045 c684241801000072 c684241901000072 c684241a0100006f }
            // n = 6, score = 900
            //   c684241501000073     | mov                 byte ptr [esp + 0x115], 0x73
            //   c684241601000074     | mov                 byte ptr [esp + 0x116], 0x74
            //   c684241701000045     | mov                 byte ptr [esp + 0x117], 0x45
        ...
        $sequence_24 = { 53 56 57 ff7508 8bf1 33db 895e10 }
            // n = 7, score = 900
            //   53                   | push                ebx
            //   56                   | push                esi
            //   57                   | push                edi
        ...
        $sequence_25 = { c684249400000073 c684249500000057 c684249600000000 c684241001000047 c684241101000065 }
            // n = 5, score = 900
        ...
        $sequence_26 = { 6a14 8d4608 6a00 50 }
            // n = 4, score = 900
            //   6a14                 | push                0x14
        ...
        $sequence_27 = { c68424900000006f c684249100000063 c684249200000065 c684249300000073 c684249400000073 }
            // n = 5, score = 900
        ...
        $sequence_28 = { 8d4f04 c70702000000 8b4624 51 }
            // n = 4, score = 900
        ...
        $sequence_29 = { 6a65 668945f0 66894dec 59 6a25 58 6a30 }
            // n = 7, score = 900
            //   6a65                 | push                0x65
        ...
        $sequence_30 = { c684248b00000061 c684248c00000074 c684248d00000065 c684248e00000050 c684248f00000072 }
            // n = 5, score = 900
        ...
        $sequence_31 = { 6a69 66894de8 59 6a70 }
            // n = 4, score = 900
            //   6a69                 | push                0x69
        ...
        $sequence_32 = { c645993b c6459a20 c6459b62 c6459c6f c6459d75 c6459e6e }
            // n = 6, score = 900
            //   c645993b             | mov                 byte ptr [ebp - 0x67], 0x3b
            //   c6459a20             | mov                 byte ptr [ebp - 0x66], 0x20
            //   c6459b62             | mov                 byte ptr [ebp - 0x65], 0x62
            //   c6459c6f             | mov                 byte ptr [ebp - 0x64], 0x6f
            //   c6459d75             | mov                 byte ptr [ebp - 0x63], 0x75
            //   c6459e6e             | mov                 byte ptr [ebp - 0x62], 0x6e

        $sequence_33 = { ebd2 c78424a000000068000000 c78424dc00000001000000 33c0 66898424e0000000 }
            // n = 5, score = 900
            //   ebd2                 | jmp                 0xffffffd4
        ...
        $sequence_34 = { 6a14 8938 8b4624 8d5e08 57 53 897dfc }
            // n = 7, score = 900
            //   6a14                 | push                0x14
        ...
        $sequence_36 = { 8d8505feffff 50 e8???????? 83c40c }
            // n = 4, score = 700
            //   8d8505feffff         | lea                 eax, dword ptr [ebp - 0x1fb]
            //   50                   | push                eax
            //   e8????????           |                     
            //   83c40c               | add                 esp, 0xc
        ...
        $sequence_37 = { c645d316 c645d43a c645d53b c645d63b c645d730 }
            ...
            //   c645d53b             | push                1
            //   c645d63b             | push                eax
            //   c645d730             | add                 esp, 0x10

        $sequence_38 = { c645cb30 c645cc27 c645cd3b c645ce30 }
            // n = 4, score = 700
            //   c645cb30             | add                 esp, 0x14
            //   c645cc27             | push                eax
            //   c645cd3b             | push                1
            //   c645ce30             | push                eax
        ...
        $sequence_40 = { 488b0f 894130 eb06 488b07 896830 }
            // n = 5, score = 500
            //   488b0f               | add                 esp, 0x10
            //   894130               | mov                 ecx, eax
            //   eb06                 | mov                 dword ptr [ebp - 4], 0xffffffff
            //   488b07               | dec                 eax
            //   896830               | mov                 eax, dword ptr [ebx + 0x38]

        $sequence_41 = { 488b4608 488b0e 48894628 488b4638 }
            // n = 4, score = 500
            //   488b4608             | dec                 eax
            //   488b0e               | mov                 ecx, dword ptr [esi]
            //   48894628             | dec                 eax
            //   488b4638             | mov                 dword ptr [esi + 0x28], eax

        $sequence_42 = { 488b0f 488b4108 48894128 488b0f 48396928 }
            // n = 5, score = 500
            //   488b0f               | dec                 eax
            //   488b4108             | mov                 dword ptr [esi + 0x28], eax
            //   48894128             | dec                 eax
            //   488b0f               | mov                 eax, dword ptr [esi + 0x38]
            //   48396928             | dec                 esp

        $sequence_43 = { 4533c9 488bd6 ff90c8010000 8bf8 85c0 }
            // n = 5, score = 500
            //   4533c9               | mov                 dword ptr [esi + 0x28], eax
            //   488bd6               | dec                 eax
            //   ff90c8010000         | mov                 eax, dword ptr [esi + 0x38]
            //   8bf8                 | dec                 esp
            //   85c0                 | lea                 ecx, dword ptr [esp + 0x50]

        $sequence_44 = { 488b5738 488bce 8bd8 ff92e8010000 488b6c2458 }
            // n = 5, score = 500
            //   488b5738             | inc                 esp
            //   488bce               | mov                 eax, ebx
            //   8bd8                 | dec                 eax
            //   ff92e8010000         | mov                 edx, edi
            //   488b6c2458           | dec                 eax

        $sequence_45 = { 488b4638 488b0e 4c8d442450 4533c9 }
            // n = 4, score = 500
            //   488b4638             | dec                 eax
            //   488b0e               | mov                 eax, dword ptr [esi + 8]
            //   4c8d442450           | dec                 eax
            //   4533c9               | mov                 ecx, dword ptr [esi]

        $sequence_46 = { 488bcf c744242088130000 e8???????? 488b5738 }
            // n = 4, score = 500
            //   488bcf               | mov                 eax, ebx
            //   c744242088130000     | dec                 eax
            //   e8????????           |                     
            //   488b5738             | mov                 edx, edi

        $sequence_47 = { 83c904 c1e803 448bc9 440fafc8 }
            // n = 4, score = 500
            //   83c904               | dec                 eax
        ...
        $sequence_48 = { 488b0f 488901 488b07 488338ff }
            // n = 4, score = 500
            //   488b0f               | dec                 eax
            //   488901               | mov                 dword ptr [esi + 0x28], eax
            //   488b07               | dec                 eax
            //   488338ff             | mov                 eax, dword ptr [esi + 0x38]

        $sequence_49 = { 48894628 488b4638 4c8d4c2450 448bc3 488bd7 }
            // n = 5, score = 500
            //   48894628             | mov                 ecx, esi
            //   488b4638             | inc                 esp
            //   4c8d4c2450           | lea                 eax, dword ptr [edx + 0x20]
            //   448bc3               | dec                 eax
            //   488bd7               | mov                 dword ptr [esi + 0x28], eax

        $sequence_50 = { 488b07 896830 33c0 488b5c2458 488b6c2460 }
            // n = 5, score = 500
            //   488b07               | dec                 esp
            //   896830               | lea                 ecx, dword ptr [esp + 0x50]
            //   33c0                 | inc                 esp
            //   488b5c2458           | mov                 eax, ebx
            //   488b6c2460           | dec                 eax

        $sequence_51 = { 488b0f 48894108 488b0f 488b4108 }
            // n = 4, score = 500
            //   488b0f               | inc                 esp
            //   48894108             | mov                 eax, ebx
            //   488b0f               | dec                 eax
            //   488b4108             | mov                 edx, edi

        $sequence_52 = { 8d8594faffff 50 68???????? ff15???????? }
            // n = 4, score = 200
            //   8d8594faffff         | lea                 eax, dword ptr [ebp - 0x56c]
            //   50                   | push                eax
            //   68????????           |                     
            //   ff15????????         |                     
        ...
        $sequence_59 = { 030c85100b4200 eb02 8bcb f6412480 }
            // n = 4, score = 100
