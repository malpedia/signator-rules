rule win_agent_btz_auto {
    ...
    strings:
        ...
        $sequence_2 = { 50 ffd3 85c0 75d8 5f 5e }
            // n = 6, score = 2500
            //   50                   | push                eax
            //   ffd3                 | call                ebx
            //   85c0                 | test                eax, eax
        ...
        $sequence_3 = { ff15???????? b800000f00 8b4df4 64890d00000000 5f 5e }
            // n = 6, score = 2400
            //   ff15????????         |                     
        ...
        $sequence_5 = { ff15???????? 894614 33c0 33db }
            // n = 4, score = 2300
            //   ff15????????         |                     
        ...
        $sequence_7 = { 8b4608 c706???????? 85c0 7413 }
            // n = 4, score = 2200
        ...
        $sequence_12 = { 6a0a 68???????? 6a01 6a00 68???????? }
            // n = 5, score = 1400
            //   6a0a                 | push                0xa
            //   68????????           |                     
            //   6a01                 | push                1
        ...
        $sequence_16 = { 50 e8???????? 83c408 6800010000 e8???????? }
            // n = 5, score = 1000
            //   50                   | push                eax
            //   e8????????           |                     
            //   83c408               | add                 esp, 8
        ...
        $sequence_18 = { 6a01 68???????? e8???????? 83c414 5f 5e 5b }
            // n = 7, score = 1000
            //   6a01                 | push                1
            //   68????????           |                     
            //   e8????????           |                     
        ...
        $sequence_19 = { 6a01 e8???????? 50 e8???????? 83c418 }
            // n = 5, score = 1000
            //   6a01                 | pop                 edi
            //   e8????????           |                     
            //   50                   | pop                 esi
        ...
        $sequence_20 = { 7511 e8???????? 83c020 50 e8???????? 83c404 }
            // n = 6, score = 1000
            //   7511                 | push                0
            //   e8????????           |                     
            //   83c020               | push                0xa
        ...
        $sequence_21 = { c684249200000065 c684249300000073 c684249400000073 c684249500000057 c684249600000000 c684241001000047 }
            // n = 6, score = 900
        ...
        $sequence_22 = { 83c414 c9 c3 55 8bec 81ec18020000 6a25 }
            // n = 7, score = 900
            //   83c414               | add                 esp, 0x14
            //   c9                   | leave               
            //   c3                   | ret                 
        ...
        $sequence_23 = { 8b451c 8b4df8 8908 895e0c c74610c8000000 eb0f c7460c08000000 }
            // n = 7, score = 900
            //   8b451c               | mov                 eax, dword ptr [ebp + 0x1c]
            //   8b4df8               | mov                 ecx, dword ptr [ebp - 8]
            //   8908                 | mov                 dword ptr [eax], ecx
            //   895e0c               | mov                 dword ptr [esi + 0xc], ebx
            //   c74610c8000000       | mov                 dword ptr [esi + 0x10], 0xc8
            //   eb0f                 | jmp                 0x11
            //   c7460c08000000       | mov                 dword ptr [esi + 0xc], 8

        $sequence_24 = { 8d4dd8 51 ff750c 8d4de4 51 }
            // n = 5, score = 900
        ...
        $sequence_26 = { c684241501000073 c684241601000074 c684241701000045 c684241801000072 c684241901000072 }
            // n = 5, score = 900
        ...
        $sequence_27 = { c684248a00000065 c684248b00000061 c684248c00000074 c684248d00000065 c684248e00000050 }
            // n = 5, score = 900
        ...
        $sequence_28 = { c684249500000057 c684249600000000 c684241001000047 c684241101000065 c684241201000074 c68424130100004c c684241401000061 }
            // n = 7, score = 900
            //   c684249500000057     | mov                 byte ptr [esp + 0x95], 0x57
            //   c684249600000000     | mov                 byte ptr [esp + 0x96], 0
            //   c684241001000047     | mov                 byte ptr [esp + 0x110], 0x47
        ...
        $sequence_29 = { 8d8df4feffff 51 8d8df8feffff 51 6813000020 }
            // n = 5, score = 900
        ...
        $sequence_30 = { 8b4d1c 8b09 034df4 51 }
            // n = 4, score = 900
        ...
        $sequence_31 = { 51 6813000020 ff75f8 c785f4feffff04000000 }
            // n = 4, score = 900
            //   51                   | push                ecx
            //   6813000020           | push                0x20000013
            //   ff75f8               | push                dword ptr [ebp - 8]
            //   c785f4feffff04000000     | mov    dword ptr [ebp - 0x10c], 4

        $sequence_32 = { 8d8d88feffff 51 8d4dcc 51 8d8d54fbffff }
            // n = 5, score = 900
            //   8d8d88feffff         | lea                 ecx, [ebp - 0x178]
            //   51                   | push                ecx
            //   8d4dcc               | lea                 ecx, [ebp - 0x34]
            //   51                   | push                ecx
            //   8d8d54fbffff         | lea                 ecx, [ebp - 0x4ac]

        $sequence_33 = { c684248d00000065 c684248e00000050 c684248f00000072 c68424900000006f c684249100000063 }
            // n = 5, score = 900
            //   c684248d00000065     | mov                 byte ptr [esp + 0x8d], 0x65
            //   c684248e00000050     | mov                 byte ptr [esp + 0x8e], 0x50
        ...
        $sequence_34 = { 6a00 6a27 6a02 6a00 6a01 }
            // n = 5, score = 800
            //   6a00                 | push                0
            //   6a27                 | push                0x27
            //   6a02                 | push                2
        ...
        $sequence_35 = { c645cb30 c645cc27 c645cd3b c645ce30 }
            // n = 4, score = 700
            //   c645cb30             | push                1
            //   c645cc27             | push                eax
            //   c645cd3b             | push                edx
        ...
        $sequence_36 = { c645d53b c645d63b c645d730 c645d836 }
            // n = 4, score = 700
        ...
        $sequence_40 = { 488bcf c744242088130000 e8???????? 488b5738 }
            // n = 4, score = 500
            //   488bcf               | mov                 edx, edi
            //   c744242088130000     | dec                 eax
            //   e8????????           |                     
            //   488b5738             | mov                 dword ptr [esi + 0x28], eax

        $sequence_41 = { 488b0f 894130 eb06 488b07 896830 }
            // n = 5, score = 500
            //   488b0f               | push                eax
            //   894130               | push                1
            //   eb06                 | push                eax
        ...
        $sequence_42 = { 488b07 896830 33c0 488b5c2458 488b6c2460 }
            // n = 5, score = 500
            //   488b07               | push                eax
            //   896830               | add                 esp, 4
            //   33c0                 | add                 eax, 0x20
            //   488b5c2458           | push                eax
            //   488b6c2460           | add                 esp, 4

        $sequence_43 = { 488bf0 c70005000000 85db 7415 4c8b4f38 }
            // n = 5, score = 500
            //   488bf0               | mov                 edx, edi
            //   c70005000000         | dec                 eax
            //   85db                 | mov                 dword ptr [esi + 0x28], eax
            //   7415                 | dec                 eax
            //   4c8b4f38             | mov                 eax, dword ptr [esi + 0x38]

        $sequence_44 = { 488b4108 48894128 488b0f 48396928 }
            // n = 4, score = 500
            //   488b4108             | add                 esp, 0x18
            //   48894128             | mov                 byte ptr [ebp - 0x2b], 0x3b
            //   488b0f               | mov                 byte ptr [ebp - 0x2a], 0x3b
            //   48396928             | mov                 byte ptr [ebp - 0x29], 0x30

        $sequence_45 = { 488b4608 488b0e 48894628 488b4638 4c8d4c2450 }
            // n = 5, score = 500
        ...
        $sequence_46 = { 488b0f 48894108 488b0f 488b4108 48894128 }
            // n = 5, score = 500
            //   488b0f               | mov                 byte ptr [ebp - 0x2c], 0x3a
            //   48894108             | mov                 byte ptr [ebp - 0x2b], 0x3b
            //   488b0f               | mov                 byte ptr [ebp - 0x2a], 0x3b
            //   488b4108             | mov                 byte ptr [ebp - 0x29], 0x30
            //   48894128             | mov                 byte ptr [ebp - 0x35], 0x30

        $sequence_47 = { 488b4638 4c8d4c2450 448bc3 488bd7 }
            // n = 4, score = 500
            //   488b4638             | dec                 esp
            //   4c8d4c2450           | lea                 ecx, [esp + 0x50]
            //   448bc3               | dec                 eax
            //   488bd7               | mov                 eax, dword ptr [esi + 8]

        $sequence_48 = { 488b0f 488901 488b07 488338ff }
            // n = 4, score = 500
            //   488b0f               | mov                 byte ptr [ebp - 0x2b], 0x3b
            //   488901               | mov                 byte ptr [ebp - 0x2a], 0x3b
            //   488b07               | mov                 byte ptr [ebp - 0x29], 0x30
            //   488338ff             | mov                 byte ptr [ebp - 0x28], 0x36

        $sequence_49 = { 83c904 c1e803 448bc9 440fafc8 }
            // n = 4, score = 500
            //   83c904               | dec                 eax
            //   c1e803               | mov                 ecx, dword ptr [esi]
            //   448bc9               | dec                 eax
            //   440fafc8             | mov                 dword ptr [esi + 0x28], eax

        $sequence_50 = { 488bce 8bd8 ff92e8010000 488b6c2458 8bc3 488b5c2450 4883c430 }
            // n = 7, score = 500
            //   488bce               | dec                 eax
        ...
        $sequence_57 = { 0304b5100b4200 59 5e eb05 }
            // n = 4, score = 100
            //   0304b5100b4200       | add                 eax, dword ptr [esi*4 + 0x420b10]
            //   59                   | pop                 ecx
            //   5e                   | pop                 esi
