rule win_clop_auto {
    ...
    strings:
        ...
        $sequence_4 = { 53 ff15???????? 50 ff15???????? 56 53 8bf8 }
            // n = 7, score = 800
            //   53                   | push                ebx
            //   ff15????????         |                     
            //   50                   | push                eax
        ...
        $sequence_6 = { e8???????? 8be5 5d c20400 56 ff15???????? 6a00 }
            // n = 7, score = 500
            //   e8????????           |                     
            //   8be5                 | mov                 esp, ebp
            //   5d                   | pop                 ebp
        ...
        $sequence_7 = { 0f85aa010000 68???????? 8d442450 50 }
            // n = 4, score = 500
        ...
        $sequence_8 = { 68???????? 50 ffd3 8d85d4f7ffff }
            // n = 4, score = 500
            //   68????????           |                     
            //   50                   | push                eax
            //   ffd3                 | call                ebx
        ...
        $sequence_9 = { 55 8bec 83ec1c 8d45ec }
            // n = 4, score = 500
            //   55                   | push                ebp
            //   8bec                 | mov                 ebp, esp
            //   83ec1c               | sub                 esp, 0x1c
        ...
        $sequence_10 = { ff15???????? 68???????? 8d85dcf7ffff 50 }
            // n = 4, score = 400
            //   ff15????????         |                     
            //   68????????           |                     
        ...
        $sequence_13 = { 83c40c 33f6 85ff 7428 }
            // n = 4, score = 300
            //   83c40c               | add                 esp, 0xc
            //   33f6                 | xor                 esi, esi
            //   85ff                 | test                edi, edi
        ...
        $sequence_14 = { 6aff ffd7 8b4dfc 33c0 }
            // n = 4, score = 300
            //   6aff                 | push                -1
            //   ffd7                 | call                edi
        ...
        $sequence_15 = { 8d85c8efffff 50 6a08 6a01 }
            // n = 4, score = 300
        ...
        $sequence_16 = { ff15???????? 6a00 6a00 e8???????? 83c408 6aff ff15???????? }
            // n = 7, score = 300
            //   ff15????????         |                     
            //   6a00                 | push                0
            //   6a00                 | push                0
        ...
        $sequence_18 = { 660fd60f 8d7f08 8b048df4ad4000 ffe0 }
            // n = 4, score = 200
            //   660fd60f             | movq                qword ptr [edi], xmm1
            //   8d7f08               | lea                 edi, [edi + 8]
            //   8b048df4ad4000       | mov                 eax, dword ptr [ecx*4 + 0x40adf4]
            //   ffe0                 | jmp                 eax
