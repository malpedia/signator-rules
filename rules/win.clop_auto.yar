rule win_clop_auto {
    ...
    strings:
        $sequence_0 = { 8bf0 56 53 ff15???????? 50 ff15???????? }
            // n = 6, score = 800
            //   8bf0                 | mov                 esi, eax
            //   56                   | push                esi
            //   53                   | push                ebx
        ...
        $sequence_3 = { 56 53 8bf8 ff15???????? 8bf0 56 }
            // n = 6, score = 800
            //   56                   | push                esi
            //   53                   | push                ebx
            //   8bf8                 | mov                 edi, eax
        ...
        $sequence_4 = { ff15???????? 50 ff15???????? 56 53 8bf8 }
            // n = 6, score = 800
            //   ff15????????         |                     
            //   50                   | push                eax
            //   ff15????????         |                     
        ...
        $sequence_5 = { 6a04 6800300000 6887000000 6a00 }
            // n = 4, score = 800
            //   6a04                 | push                4
        ...
        $sequence_7 = { c20400 56 ff15???????? 6a00 }
            // n = 4, score = 500
            //   c20400               | ret                 4
            //   56                   | push                esi
            //   ff15????????         |                     
        ...
        $sequence_8 = { 8b1d???????? 8d85d4f7ffff 68???????? 50 ffd3 }
            // n = 5, score = 500
            //   8b1d????????         |                     
        ...
        $sequence_9 = { 6888130000 ffd7 6a00 6a00 6a00 }
            // n = 5, score = 500
        ...
        $sequence_10 = { 8d85d4f7ffff 6a00 50 e8???????? 83c40c }
            // n = 5, score = 500
            //   8d85d4f7ffff         | lea                 eax, [ebp - 0x82c]
            //   6a00                 | push                0
            //   50                   | push                eax
        ...
        $sequence_11 = { 0f85aa010000 68???????? 8d442450 50 }
            // n = 4, score = 500
        ...
        $sequence_14 = { ffd0 c3 8bff 55 8bec 83ec1c 8d4de4 }
            // n = 7, score = 400
            //   ffd0                 | call                eax
            //   c3                   | ret                 
            //   8bff                 | mov                 edi, edi
        ...
        $sequence_17 = { 6a00 e8???????? 83c408 6aff ff15???????? 33c0 }
            // n = 6, score = 300
            //   6a00                 | push                0
            //   e8????????           |                     
            //   83c408               | add                 esp, 8
