rule win_qakbot_auto {
    ...
    meta:
        ...
        date = "2022-04-08"
        version = "1"
        description = "Describes win.qakbot."
    ...
    strings:
        ...
        $sequence_3 = { 740d 8d45fc 6a00 50 e8???????? 59 }
            // n = 6, score = 4800
            //   740d                 | je                  0xf
        ...
        $sequence_4 = { 7402 ebfa 33c0 7402 }
            // n = 4, score = 4600
            //   7402                 | je                  4
            //   ebfa                 | jmp                 0xfffffffc
            //   33c0                 | xor                 eax, eax
        ...
        $sequence_5 = { ebfa eb06 33c0 7402 }
            // n = 4, score = 4600
            //   ebfa                 | jmp                 0xfffffffc
            //   eb06                 | jmp                 8
            //   33c0                 | xor                 eax, eax
        ...
        $sequence_11 = { c74508???????? e8???????? 85c0 7d08 83c8ff }
            // n = 5, score = 3900
            //   c74508????????       |                     
            //   e8????????           |                     
            //   85c0                 | test                eax, eax
        ...
        $sequence_12 = { 57 6a00 6a02 ff15???????? 8bf8 83c8ff 3bf8 }
            // n = 7, score = 3900
            //   57                   | push                edi
            //   6a00                 | push                0
            //   6a02                 | push                2
        ...
        $sequence_13 = { 85c0 750c 57 ff15???????? 6afe 58 }
            // n = 6, score = 3900
            //   85c0                 | test                eax, eax
            //   750c                 | jne                 0xe
            //   57                   | push                edi
        ...
        $sequence_17 = { 817de8ffffff7f 7506 837dec00 740f }
            // n = 4, score = 3600
        ...
        $sequence_21 = { 00ca 66897c2446 31f6 8974244c }
            // n = 4, score = 100
            //   00ca                 | add                 dl, cl
        ...
        $sequence_23 = { 01c1 8b442448 01c8 8944243c }
            // n = 4, score = 100
            //   01c1                 | add                 ecx, eax
        ...
        $sequence_24 = { 01c1 894c2404 8b442404 8d65fc }
            // n = 4, score = 100
            //   01c1                 | add                 ecx, eax
        ...
        $sequence_25 = { 01c1 81e1ffff0000 83c101 8b442474 }
            // n = 4, score = 100
            //   01c1                 | add                 ecx, eax
        ...
        $sequence_26 = { 00e9 884c0451 83c001 39d0 }
            // n = 4, score = 100
            //   00e9                 | add                 cl, ch
        ...
        $sequence_28 = { 01c1 894c2430 e9???????? 55 }
            // n = 4, score = 100
            //   01c1                 | add                 ecx, eax
