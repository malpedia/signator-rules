rule win_qakbot_auto {
    ...
    strings:
        ...
        $sequence_11 = { c3 33c9 3d80000000 0f94c1 }
            // n = 4, score = 3900
            //   c3                   | ret                 
            //   33c9                 | xor                 ecx, ecx
        ...
        $sequence_13 = { 6a00 6a02 ff15???????? 8bf8 83c8ff }
            // n = 5, score = 3900
            //   6a00                 | push                0
            //   6a02                 | push                2
            //   ff15????????         |                     
        ...
        $sequence_17 = { 7506 837dec00 740f 817de800000080 }
            // n = 4, score = 3600
            //   7506                 | jne                 8
        ...
        $sequence_18 = { 50 68???????? 6a3f 8d45c0 50 }
            // n = 5, score = 3600
            //   50                   | push                eax
            //   68????????           |                     
            //   6a3f                 | push                0x3f
        ...
        $sequence_21 = { 01c1 894c2430 e9???????? 55 }
            // n = 4, score = 100
            //   01c1                 | add                 ecx, eax
        ...
        $sequence_22 = { 01c1 8b442448 01c8 8944243c }
            // n = 4, score = 100
            //   01c1                 | add                 ecx, eax
        ...
        $sequence_24 = { 01c1 81e1ffff0000 83c101 8b442474 }
            // n = 4, score = 100
            //   01c1                 | add                 ecx, eax
