rule win_contopee_auto {
    ...
    strings:
        ...
        $sequence_1 = { 83c404 6a00 6880000000 6a04 6a00 6a01 }
            // n = 6, score = 100
            //   83c404               | add                 esp, 4
            //   6a00                 | push                0
        ...
        $sequence_4 = { 50 ff15???????? 8d8ed00f0000 8d96c80f0000 51 52 }
            ...
            //   50                   | push                eax
            //   ff15????????         |                     
            //   8d8ed00f0000         | lea                 ecx, dword ptr [esi + 0xfd0]
            //   8d96c80f0000         | lea                 edx, dword ptr [esi + 0xfc8]
            //   51                   | push                ecx
            //   52                   | push                edx
        ...
        $sequence_8 = { 8d8c2450020000 50 8d54240c 51 52 68???????? 8d866a070000 }
            // n = 7, score = 100
            //   8d8c2450020000       | lea                 ecx, dword ptr [esp + 0x250]
            //   50                   | push                eax
            //   8d54240c             | lea                 edx, dword ptr [esp + 0xc]
            //   51                   | push                ecx
            //   52                   | push                edx
            //   68????????           |                     
            //   8d866a070000         | lea                 eax, dword ptr [esi + 0x76a]
