rule win_kleptoparasite_stealer_auto {
    ...
    strings:
        ...
        $sequence_1 = { 7405 8901 895104 8be5 5d c3 3b0d???????? }
            // n = 7, score = 300
            //   7405                 | je                  7
        ...
        $sequence_4 = { e8???????? cc 55 8bec 56 e8???????? 8b7508 }
            // n = 7, score = 300
            //   e8????????           |                     
            //   cc                   | int3                
            //   55                   | push                ebp
        ...
        $sequence_5 = { c3 e9???????? 55 8bec 56 e8???????? 8bf0 }
            // n = 7, score = 300
            //   c3                   | ret                 
            //   e9????????           |                     
            //   55                   | push                ebp
        ...
        $sequence_6 = { 895104 8be5 5d c3 3b0d???????? 7502 }
            // n = 6, score = 300
            //   895104               | mov                 dword ptr [ecx + 4], edx
            //   8be5                 | mov                 esp, ebp
            //   5d                   | pop                 ebp
        ...
        $sequence_7 = { ebe4 6a0c 68???????? e8???????? 8365e400 33c0 8b7d08 }
            // n = 7, score = 300
            //   ebe4                 | jmp                 0xffffffe6
            //   6a0c                 | push                0xc
            //   68????????           |                     
