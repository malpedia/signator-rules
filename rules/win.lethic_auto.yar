rule win_lethic_auto {
    ...
    strings:
        $sequence_0 = { 894dfc ebec 8b55fc 8b45f4 8b08 890a }
            // n = 6, score = 1200
        ...
        $sequence_1 = { 740a 8b45fc 8b08 894dfc ebec 8b55fc 8b45f4 }
            // n = 7, score = 1200
            //   740a                 | je                  0xc
        ...
        $sequence_2 = { 034510 8945f4 8b4df8 3b4df4 }
            // n = 4, score = 1200
        ...
        $sequence_3 = { 894df0 8b550c 8955f8 8b45f8 034510 8945f4 8b4df8 }
            // n = 7, score = 1200
        ...
        $sequence_4 = { 83ec0c 8b4508 8945f4 6838100000 }
            // n = 4, score = 1200
            //   83ec0c               | sub                 esp, 0xc
        ...
        $sequence_6 = { 034510 8945f4 8b4df8 3b4df4 741e 8b55fc }
            // n = 6, score = 1200
            //   034510               | add                 eax, dword ptr [ebp + 0x10]
            //   8945f4               | mov                 dword ptr [ebp - 0xc], eax
            //   8b4df8               | mov                 ecx, dword ptr [ebp - 8]
        ...
        $sequence_7 = { 034d0c 894df8 8b55fc 3b55f8 7411 }
            // n = 5, score = 1200
        ...
        $sequence_8 = { e9???????? 8b45fc 8b4d10 894804 }
            // n = 4, score = 1200
            //   e9????????           |                     
            //   8b45fc               | mov                 eax, dword ptr [ebp - 4]
