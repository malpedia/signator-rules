rule win_finfisher_auto {
    ...
    strings:
        ...
        $sequence_3 = { 8bd8 3bdf 740b ff75fc ff15???????? }
            // n = 5, score = 100
            //   8bd8                 | mov                 ebx, eax
            //   3bdf                 | cmp                 ebx, edi
            //   740b                 | je                  0xd
        ...
        $sequence_5 = { bb0d0000c0 e9???????? 8b790c 8b4718 }
            // n = 4, score = 100
            //   bb0d0000c0           | mov                 ebx, 0xc000000d
            //   e9????????           |                     
            //   8b790c               | mov                 edi, dword ptr [ecx + 0xc]
            //   8b4718               | mov                 eax, dword ptr [edi + 0x18]

        $sequence_6 = { 0118 8b45f0 83450802 4f }
            // n = 4, score = 100
        ...
        $sequence_7 = { 50 ff750c ff7304 ff15???????? }
            // n = 4, score = 100
            //   50                   | push                eax
        ...
        $sequence_8 = { 011a 8b55f0 83450802 49 }
            // n = 4, score = 100
        ...
        $sequence_10 = { 48 6683385c 898590f7ffff 75f2 668930 }
            // n = 5, score = 100
            //   48                   | dec                 eax
        ...
        $sequence_11 = { ff15???????? 8b9d94f7ffff ffb5bcf7ffff ffb5b4f7ffff }
            // n = 4, score = 100
            //   ff15????????         |                     
            //   8b9d94f7ffff         | mov                 ebx, dword ptr [ebp - 0x86c]
            //   ffb5bcf7ffff         | push                dword ptr [ebp - 0x844]
            //   ffb5b4f7ffff         | push                dword ptr [ebp - 0x84c]

        $sequence_12 = { 0108 83500400 a1???????? 8380780300003c 83fbfd }
            // n = 5, score = 100
