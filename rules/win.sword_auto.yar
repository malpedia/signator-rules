rule win_sword_auto {
    ...
    strings:
        $sequence_0 = { 83d8ff 3bc3 7472 385c2428 0f849f000000 8d8424940a0000 }
            ...
            //   8d8424940a0000       | lea                 eax, dword ptr [esp + 0xa94]
        ...
        $sequence_2 = { 8d542418 8d842424030000 52 50 e8???????? 8d4c2420 6a3a }
            ...
            //   8d842424030000       | lea                 eax, dword ptr [esp + 0x324]
            //   52                   | push                edx
            //   50                   | push                eax
            //   e8????????           |                     
        ...
        $sequence_5 = { e8???????? 8d8c248c020000 6a5c 51 8bf0 }
            // n = 5, score = 100
            //   e8????????           |                     
            //   8d8c248c020000       | lea                 ecx, dword ptr [esp + 0x28c]
            //   6a5c                 | push                0x5c
            //   51                   | push                ecx
            //   8bf0                 | mov                 esi, eax
        ...
        $sequence_8 = { 8dbc2494060000 83c9ff 33c0 f2ae f7d1 49 }
            // n = 6, score = 100
            //   8dbc2494060000       | lea                 edi, dword ptr [esp + 0x694]
            //   83c9ff               | or                  ecx, 0xffffffff
            //   33c0                 | xor                 eax, eax
