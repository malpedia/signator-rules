rule win_anatova_ransom_auto {
    ...
    strings:
        ...
        $sequence_1 = { 488d055d2a0000 488945c8 488d05622a0000 488945d0 488d05672a0000 488945d8 488d05642a0000 }
            // n = 7, score = 100
            //   488d055d2a0000       | mov                 dword ptr [ebp - 0x48], eax
            //   488945c8             | dec                 eax
            //   488d05622a0000       | lea                 eax, dword ptr [0x39f7]
            //   488945d0             | dec                 eax
            //   488d05672a0000       | mov                 dword ptr [ebp - 0x40], eax
            //   488945d8             | dec                 eax
            //   488d05642a0000       | lea                 eax, dword ptr [0x57f4]
        ...
        $sequence_3 = { 894598 488b45f8 4989c2 4c89d1 e8???????? 8b4d98 4863c9 }
            ...
            //   894598               | inc                 ecx
            //   488b45f8             | call                ebx
            //   4989c2               | mov                 dword ptr [ebp - 0xc], eax
            //   4c89d1               | mov                 eax, dword ptr [ebp - 0xc]
            //   e8????????           |                     
            //   8b4d98               | cmp                 eax, 0
            //   4863c9               | jbe                 0xcf8
        ...
        $sequence_4 = { 488b85c0feffff 4883c02c 488b8db0feffff 4989cb }
            ...
            //   4883c02c             | lea                 eax, dword ptr [0x65bd]
        ...
        $sequence_5 = { 8908 488b4528 488b4d28 488b5520 }
            ...
            //   488b4528             | dec                 eax
            //   488b4d28             | lea                 eax, dword ptr [0x64a9]
            //   488b5520             | dec                 eax

        $sequence_6 = { 83fa00 0f8445000000 8b4528 c1e806 }
            // n = 4, score = 100
            //   83fa00               | dec                 eax
            //   0f8445000000         | lea                 eax, dword ptr [0x3025]
            //   8b4528               | dec                 eax
