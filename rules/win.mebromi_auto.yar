rule win_mebromi_auto {
    ...
    meta:
        ...
        date = "2022-04-08"
        version = "1"
        description = "Describes win.mebromi."
    ...
    strings:
        ...
        $sequence_4 = { 50 a3???????? e8???????? 8db67c722900 bf???????? a5 a5 }
            ...
            //   a3????????           |                     
            //   e8????????           |                     
            //   8db67c722900         | lea                 esi, dword ptr [esi + 0x29727c]
            //   bf????????           |                     
        ...
        $sequence_5 = { 8b7d08 8d05549d2900 83780800 753b b0ff 8bff }
            ...
            //   8d05549d2900         | lea                 eax, dword ptr [0x299d54]
        ...
        $sequence_9 = { c1e604 aa 8d9e88722900 803b00 8bcb 742c 8a5101 }
            ...
            //   8d9e88722900         | lea                 ebx, dword ptr [esi + 0x297288]
