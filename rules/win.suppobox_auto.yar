rule win_suppobox_auto {
    ...
    strings:
        ...
        $sequence_13 = { 8b9300010000 81faff000000 744e 8d4201 898300010000 c6041329 c6830401000029 }
            // n = 7, score = 100
            ...
            //   c6041329             | mov                 byte ptr [ebx + edx], 0x29
            //   c6830401000029       | mov                 byte ptr [ebx + 0x104], 0x29
        ...
        $sequence_15 = { 8b930c010000 8944240c c683ff00000000 c7442404ff000000 }
            // n = 4, score = 100
        ...
        $sequence_16 = { 8b9318010000 85d2 743d 3dff000000 }
            // n = 4, score = 100
            //   8b9318010000         | mov                 edx, dword ptr [ebx + 0x118]
            //   85d2                 | test                edx, edx
            //   743d                 | je                  0x3f
        ...
        $sequence_17 = { 8b9318010000 85d2 743b 3dff000000 }
            // n = 4, score = 100
            //   8b9318010000         | mov                 edx, dword ptr [ebx + 0x118]
            //   85d2                 | test                edx, edx
            //   743b                 | je                  0x3d
        ...
        $sequence_19 = { 8b930c010000 c6040300 89442404 891c24 }
            // n = 4, score = 100
            //   8b930c010000         | mov                 edx, dword ptr [ebx + 0x10c]
        ...
        $sequence_20 = { 01c6 39fe 0f8d7e010000 80bc2ef4f7ffff0a }
            // n = 4, score = 100
            //   01c6                 | add                 esi, eax
            //   39fe                 | cmp                 esi, edi
        ...
        $sequence_21 = { 01d8 3b85b0f7ffff 7e2f 8b95c8f7ffff }
            // n = 4, score = 100
            //   01d8                 | add                 eax, ebx
