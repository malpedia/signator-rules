rule win_suppobox_auto {
    ...
    strings:
        ...
        $sequence_9 = { 8b931c010000 eb05 83382f 7513 }
            // n = 4, score = 100
            //   8b931c010000         | mov                 edx, dword ptr [ebx + 0x11c]
            //   eb05                 | jmp                 7
            //   83382f               | cmp                 dword ptr [eax], 0x2f
            //   7513                 | jne                 0x15
        ...
        $sequence_12 = { 8b931c010000 eb17 8b4008 83ea01 85c0 0f8407070000 }
            // n = 6, score = 100
            //   8b931c010000         | mov                 edx, dword ptr [ebx + 0x11c]
            //   eb17                 | jmp                 0x19
            ...
            //   83ea01               | sub                 edx, 1
            //   85c0                 | test                eax, eax
            //   0f8407070000         | je                  0x70d

        $sequence_13 = { 8b930c010000 c6040300 89442404 891c24 89542408 }
            // n = 5, score = 100
        ...
        $sequence_14 = { 01c6 39fe 0f8d7e010000 80bc2ef4f7ffff0a }
            // n = 4, score = 100
            //   01c6                 | add                 esi, eax
            //   39fe                 | cmp                 esi, edi
        ...
        $sequence_21 = { 8b942450010000 894c2410 89542430 0f8381060000 }
            // n = 4, score = 100
            //   8b942450010000       | mov                 edx, dword ptr [esp + 0x150]
            //   894c2410             | mov                 dword ptr [esp + 0x10], ecx
            //   89542430             | mov                 dword ptr [esp + 0x30], edx
            //   0f8381060000         | jae                 0x687
