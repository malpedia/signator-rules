rule win_suppobox_auto {
    ...
    strings:
        ...
        $sequence_15 = { 8b85e0f8ffff a3???????? eb02 ddd8 }
            // n = 4, score = 100
            //   8b85e0f8ffff         | mov                 eax, dword ptr [ebp - 0x720]
            //   a3????????           |                     
            //   eb02                 | jmp                 4
        ...
        $sequence_17 = { 8b85ecfeffff 83e801 8985ecfeffff 0fb79532feffff }
            // n = 4, score = 100
        ...
        $sequence_18 = { 8b85e4afffff 85c0 743a 8b4d0c }
            // n = 4, score = 100
        ...
        $sequence_19 = { 8b85ecfeffff 83ec08 dd4590 dd85d0fdffff }
            // n = 4, score = 100
            //   8b85ecfeffff         | mov                 eax, dword ptr [ebp - 0x114]
            //   83ec08               | sub                 esp, 8
        ...
        $sequence_21 = { 8b85f0feffff 8dbda8feffff c7430c00000000 8db528feffff }
            // n = 4, score = 100
            //   8b85f0feffff         | mov                 eax, dword ptr [ebp - 0x110]
