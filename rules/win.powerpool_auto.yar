rule win_powerpool_auto {
    ...
    strings:
        ...
        $sequence_2 = { 8b442414 50 8d5c2424 e8???????? 8b542414 }
            // n = 5, score = 200
        ...
        $sequence_4 = { 7403 830b01 397db8 741e }
            // n = 4, score = 200
            //   7403                 | je                  5
            //   830b01               | or                  dword ptr [ebx], 1
        ...
        $sequence_6 = { 7210 8b942484000000 52 e8???????? 83c404 a1???????? }
            // n = 6, score = 200
            //   7210                 | jb                  0x12
        ...
        $sequence_7 = { 7214 8b03 3b01 7512 }
            // n = 4, score = 200
            //   7214                 | jb                  0x16
        ...
        $sequence_8 = { 7212 33c0 3bf7 0f95c0 }
            // n = 4, score = 200
            //   7212                 | jb                  0x14
            //   33c0                 | xor                 eax, eax
            //   3bf7                 | cmp                 esi, edi
        ...
        $sequence_9 = { 7210 8b8c24e0000000 51 e8???????? 83c404 8bb42404010000 }
            // n = 6, score = 200
            //   7210                 | jb                  0x12
            ...
            //   e8????????           |                     
            //   83c404               | add                 esp, 4
            //   8bb42404010000       | mov                 esi, dword ptr [esp + 0x104]
        ...
        $sequence_12 = { 7214 33d2 83f804 0f95c2 }
            // n = 4, score = 200
            //   7214                 | jb                  0x16
            //   33d2                 | xor                 edx, edx
            //   83f804               | cmp                 eax, 4
        ...
        $sequence_13 = { 7210 8b84248c000000 50 e8???????? 83c404 89bc24a0000000 }
            // n = 6, score = 200
            //   7210                 | jb                  0x12
            ...
            //   e8????????           |                     
            //   83c404               | add                 esp, 4
            //   89bc24a0000000       | mov                 dword ptr [esp + 0xa0], edi
