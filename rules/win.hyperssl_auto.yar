rule win_hyperssl_auto {
    ...
    strings:
        ...
        $sequence_1 = { 0105???????? 8d558c 89458c 894590 }
            // n = 4, score = 200
            //   0105????????         |                     
        ...
        $sequence_3 = { e8???????? 33c0 40 5d c20c00 6a08 }
            // n = 6, score = 200
            //   e8????????           |                     
            //   33c0                 | xor                 eax, eax
            //   40                   | inc                 eax
        ...
        $sequence_4 = { 0101 014514 2bf3 8b5d0c }
            // n = 4, score = 200
            //   0101                 | add                 dword ptr [ecx], eax
        ...
        $sequence_6 = { ff15???????? 8bc8 85c9 7436 8b413c }
            // n = 5, score = 200
            //   ff15????????         |                     
            //   8bc8                 | mov                 ecx, eax
            //   85c9                 | test                ecx, ecx
        ...
        $sequence_11 = { 23742418 8bf9 0b7c2454 234c2454 237c241c }
            // n = 5, score = 200
            //   23742418             | and                 esi, dword ptr [esp + 0x18]
            //   8bf9                 | mov                 edi, ecx
            //   0b7c2454             | or                  edi, dword ptr [esp + 0x54]
            //   234c2454             | and                 ecx, dword ptr [esp + 0x54]
            //   237c241c             | and                 edi, dword ptr [esp + 0x1c]

        $sequence_12 = { 40 4f 75f2 5f }
            // n = 4, score = 200
            //   40                   | inc                 eax
            //   4f                   | dec                 edi
            //   75f2                 | jne                 0xfffffff4
