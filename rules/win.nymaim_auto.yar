rule win_nymaim_auto {
    ...
    strings:
        ...
        $sequence_3 = { c1e105 01c8 c1c307 30c3 }
            // n = 4, score = 1600
            //   c1e105               | shl                 ecx, 5
            //   01c8                 | add                 eax, ecx
            //   c1c307               | rol                 ebx, 7
        ...
        $sequence_4 = { c1e902 740d 8b06 8907 83c704 }
            // n = 5, score = 1600
            //   c1e902               | shr                 ecx, 2
            //   740d                 | je                  0xf
        ...
        $sequence_5 = { 31c9 38f0 83d100 38d0 83d900 c1e105 01c8 }
            // n = 7, score = 1600
            //   31c9                 | xor                 ecx, ecx
            //   38f0                 | cmp                 al, dh
            //   83d100               | adc                 ecx, 0
        ...
        $sequence_7 = { 31d2 bf64000000 f7f7 5b 5f }
            // n = 5, score = 1600
            //   31d2                 | xor                 edx, edx
            //   bf64000000           | mov                 edi, 0x64
            //   f7f7                 | div                 edi
        ...
        $sequence_11 = { 8b4d0c 8b5d18 8b1b 4f }
            // n = 4, score = 1100
            //   8b4d0c               | mov                 ecx, dword ptr [ebp + 0xc]
            //   8b5d18               | mov                 ebx, dword ptr [ebp + 0x18]
        ...
        $sequence_17 = { 31c9 8b55f4 8b75ec 89723c c7424003000000 }
            // n = 5, score = 100
            //   31c9                 | xor                 ecx, ecx
        ...
        $sequence_21 = { 56 83ec28 8b450c 8b4d08 8d154e30d201 }
            // n = 5, score = 100
            //   56                   | push                esi
            //   83ec28               | sub                 esp, 0x28
