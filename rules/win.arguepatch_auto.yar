rule win_arguepatch_auto {
    ...
    strings:
        $sequence_0 = { 50 51 e8???????? 8b4f04 83c40c }
            // n = 5, score = 200
            //   50                   | push                eax
            //   51                   | push                ecx
            //   e8????????           |                     
        ...
        $sequence_2 = { 8b400c 8b4014 56 57 }
            // n = 4, score = 200
        ...
        $sequence_3 = { e8???????? 59 8b4df8 8d0441 }
            // n = 4, score = 200
            //   e8????????           |                     
            //   59                   | pop                 ecx
        ...
        $sequence_6 = { 59 59 85c0 740a 395df8 }
            // n = 5, score = 200
            //   59                   | pop                 ecx
            //   59                   | pop                 ecx
            //   85c0                 | test                eax, eax
        ...
        $sequence_8 = { 03c7 8b481c 8b5018 03cf }
            // n = 4, score = 200
            //   03c7                 | add                 eax, edi
        ...
        $sequence_9 = { 74bd 83c102 eb88 8bff 55 8bec 8b4d0c }
            // n = 7, score = 200
            //   74bd                 | je                  0xffffffbf
            //   83c102               | add                 ecx, 2
            //   eb88                 | jmp                 0xffffff8a
