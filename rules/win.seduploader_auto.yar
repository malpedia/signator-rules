rule win_seduploader_auto {
    ...
    strings:
        ...
        $sequence_1 = { 83c6fe 8930 8d4601 50 e8???????? }
            // n = 5, score = 2400
            //   83c6fe               | add                 esi, -2
        ...
        $sequence_4 = { 50 e8???????? 8b4510 83c6fe 8930 }
            // n = 5, score = 2400
            //   50                   | push                eax
            //   e8????????           |                     
            //   8b4510               | mov                 eax, dword ptr [ebp + 0x10]
        ...
        $sequence_6 = { 50 e8???????? 8b4510 83c6fe 8930 8d4601 50 }
            // n = 7, score = 2400
            //   50                   | push                eax
            //   e8????????           |                     
            //   8b4510               | mov                 eax, dword ptr [ebp + 0x10]
        ...
        $sequence_7 = { e8???????? 8b4510 83c6fe 8930 8d4601 50 e8???????? }
            // n = 7, score = 2400
            //   e8????????           |                     
            //   8b4510               | mov                 eax, dword ptr [ebp + 0x10]
            //   83c6fe               | add                 esi, -2
