rule win_mgbot_auto {
    ...
    meta:
        ...
        date = "2022-04-08"
        version = "1"
        description = "Describes win.mgbot."
    ...
    strings:
        ...
        $sequence_1 = { 5e c20400 ff742408 ff742408 e8???????? }
            // n = 5, score = 200
            //   5e                   | pop                 esi
            //   c20400               | ret                 4
        ...
        $sequence_3 = { 6808020000 e8???????? 6804010000 8bf0 6a00 }
            // n = 5, score = 200
            //   6808020000           | push                0x208
            //   e8????????           |                     
            //   6804010000           | push                0x104
        ...
        $sequence_7 = { 5d c20800 6808020000 e8???????? }
            // n = 4, score = 200
            //   5d                   | pop                 ebp
            //   c20800               | ret                 8
            //   6808020000           | push                0x208
