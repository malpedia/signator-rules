rule win_karagany_auto {
    ...
    strings:
        ...
        $sequence_5 = { 6a40 6800300000 6800000300 6a00 ff15???????? }
            // n = 5, score = 400
            //   6a40                 | push                0x40
            //   6800300000           | push                0x3000
            //   6800000300           | push                0x30000
        ...
        $sequence_7 = { 8945d0 8945d8 8945e0 8945e8 }
            // n = 4, score = 400
        ...
        $sequence_9 = { 894ddc 894de4 894df0 894df8 }
            // n = 4, score = 400
