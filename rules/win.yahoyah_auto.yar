rule win_yahoyah_auto {
    ...
    strings:
        ...
        $sequence_2 = { 23d1 52 8bd0 c1ea18 }
            // n = 4, score = 400
            //   23d1                 | and                 edx, ecx
            //   52                   | push                edx
            //   8bd0                 | mov                 edx, eax
        ...
        $sequence_3 = { e8???????? 59 53 53 6a03 0fb7c8 b8???????? }
            // n = 7, score = 400
            //   e8????????           |                     
            //   59                   | pop                 ecx
            //   53                   | push                ebx
        ...
        $sequence_4 = { e8???????? 59 56 56 8d45fc 50 ff7508 }
            // n = 7, score = 400
            //   e8????????           |                     
            //   59                   | pop                 ecx
            //   56                   | push                esi
        ...
        $sequence_7 = { 8bd8 83fbff 7505 83c8ff }
            // n = 4, score = 400
            //   8bd8                 | mov                 ebx, eax
            //   83fbff               | cmp                 ebx, -1
            //   7505                 | jne                 7
        ...
        $sequence_12 = { 90 68add13441 ffb53ffbffff 6a00 e8???????? }
            // n = 5, score = 100
            //   90                   | nop                 
        ...
        $sequence_13 = { 90 33c9 33c0 648b3530000000 8b760c 8b761c 8b4608 }
            // n = 7, score = 100
            //   90                   | nop                 
            //   33c9                 | xor                 ecx, ecx
            //   33c0                 | xor                 eax, eax
        ...
        $sequence_14 = { 90 90 90 90 90 90 68add13441 }
            // n = 7, score = 100
            //   90                   | nop                 
            //   90                   | nop                 
            //   90                   | nop                 
