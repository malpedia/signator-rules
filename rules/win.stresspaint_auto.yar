rule win_stresspaint_auto {
    ...
    strings:
        ...
        $sequence_4 = { 8d4c2444 8b4220 50 51 }
            // n = 4, score = 100
            //   8d4c2444             | lea                 ecx, [esp + 0x44]
        ...
        $sequence_6 = { 8d4c2444 51 52 8d6c28ff e8???????? 83c408 85c0 }
            // n = 7, score = 100
            //   8d4c2444             | lea                 ecx, [esp + 0x44]
            //   51                   | push                ecx
            //   52                   | push                edx
            //   8d6c28ff             | lea                 ebp, [eax + ebp - 1]
            //   e8????????           |                     
            //   83c408               | add                 esp, 8
            //   85c0                 | test                eax, eax
        ...
        $sequence_10 = { 8d4c2444 51 52 e8???????? 83c408 85c0 0f853d040000 }
            // n = 7, score = 100
            //   8d4c2444             | lea                 ecx, [esp + 0x44]
            //   51                   | push                ecx
            //   52                   | push                edx
        ...
        $sequence_15 = { 8d4c2444 68???????? 51 6a64 }
            // n = 4, score = 100
            //   8d4c2444             | lea                 ecx, [esp + 0x44]
            //   68????????           |                     
            //   51                   | push                ecx
