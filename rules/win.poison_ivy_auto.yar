rule win_poison_ivy_auto {
    ...
    strings:
        $sequence_0 = { 8d86b1060000 50 6a01 6a00 8d86120e0000 50 ff75fc }
            // n = 7, score = 100
        ...
        $sequence_1 = { 7507 b902000080 eb05 b901000080 8d45fc 50 }
            // n = 6, score = 100
            //   7507                 | jne                 9
        ...
        $sequence_3 = { 50 683f000f00 6a00 57 51 ff5635 }
            // n = 6, score = 100
            //   50                   | push                eax
        ...
        $sequence_4 = { 57 ff9681000000 80beaf08000001 7507 b902000080 eb05 }
            // n = 6, score = 100
            //   57                   | push                edi
        ...
        $sequence_5 = { 51 57 ff9681000000 8d45fc 50 }
            // n = 5, score = 100
            //   51                   | push                ecx
            //   57                   | push                edi
            //   ff9681000000         | call                dword ptr [esi + 0x81]
