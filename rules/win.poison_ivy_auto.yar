rule win_poison_ivy_auto {
    ...
    strings:
        $sequence_0 = { 6a01 6a00 8d86120e0000 50 ff75fc }
            // n = 5, score = 100
            //   6a01                 | push                1
            //   6a00                 | push                0
        ...
        $sequence_1 = { 683f000f00 6a00 57 51 }
            // n = 4, score = 100
        ...
        $sequence_3 = { ff9681000000 80beaf08000001 7507 b902000080 eb05 b901000080 }
            // n = 6, score = 100
        ...
        $sequence_4 = { 59 51 57 ff9681000000 }
            // n = 4, score = 100
            //   59                   | pop                 ecx
            //   51                   | push                ecx
            //   57                   | push                edi
        ...
        $sequence_5 = { eb05 b901000080 8d45fc 50 683f000f00 }
            // n = 5, score = 100
            //   eb05                 | jmp                 7
            //   b901000080           | mov                 ecx, 0x80000001
    ...
    condition:
        all of them and filesize < 204800
}
