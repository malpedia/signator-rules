rule win_poison_ivy_auto {
    ...
    strings:
        $sequence_0 = { 80beaf08000001 7507 b902000080 eb05 b901000080 }
            // n = 5, score = 100
        ...
        $sequence_1 = { 683f000f00 6a00 57 51 ff5635 }
            // n = 5, score = 100
        ...
        $sequence_2 = { eb05 b901000080 8d45fc 50 }
            // n = 4, score = 100
            //   eb05                 | jmp                 7
            //   b901000080           | mov                 ecx, 0x80000001
        ...
        $sequence_3 = { 51 ff5635 68ff000000 8d86b1060000 50 }
            // n = 5, score = 100
            //   51                   | push                ecx
            //   ff5635               | call                dword ptr [esi + 0x35]
        ...
        $sequence_4 = { 57 ff9681000000 80beaf08000001 7507 }
            // n = 4, score = 100
            //   57                   | push                edi
        ...
        $sequence_5 = { 6a01 6a00 8d86120e0000 50 ff75fc ff563d }
            // n = 6, score = 100
            //   6a01                 | push                1
            //   6a00                 | push                0
        ...
        $sequence_6 = { 51 57 ff9681000000 8d45fc 50 683f000f00 6a00 }
            // n = 7, score = 100
            //   51                   | push                ecx
            //   57                   | push                edi
            //   ff9681000000         | call                dword ptr [esi + 0x81]
