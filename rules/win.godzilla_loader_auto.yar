rule win_godzilla_loader_auto {
    ...
    strings:
        $sequence_0 = { 6a00 6a00 8bf8 8d45fc 50 57 6a01 }
            // n = 7, score = 1500
            //   6a00                 | push                0
            //   6a00                 | push                0
            //   8bf8                 | mov                 edi, eax
        ...
        $sequence_1 = { 8d45fc 50 57 6a01 56 ff7508 8975fc }
            // n = 7, score = 1500
            //   8d45fc               | lea                 eax, [ebp - 4]
            //   50                   | push                eax
            //   57                   | push                edi
        ...
        $sequence_2 = { 50 a5 ff512c 85c0 756c }
            // n = 5, score = 1500
            //   50                   | push                eax
        ...
        $sequence_5 = { 52 50 ff91f0000000 85c0 7813 }
            // n = 5, score = 1500
            //   52                   | push                edx
            //   50                   | push                eax
        ...
        $sequence_9 = { 8bf8 8d45fc 50 57 6a01 56 }
            // n = 6, score = 1500
            //   8bf8                 | mov                 edi, eax
            //   8d45fc               | lea                 eax, [ebp - 4]
            //   50                   | push                eax
