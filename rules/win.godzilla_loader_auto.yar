rule win_godzilla_loader_auto {
    ...
    strings:
        ...
        $sequence_1 = { 6a00 6a00 8bf8 8d45fc 50 57 6a01 }
            // n = 7, score = 1500
            //   6a00                 | push                0
            //   6a00                 | push                0
            //   8bf8                 | mov                 edi, eax
        ...
        $sequence_2 = { 6a01 56 ff7508 8975fc }
            // n = 4, score = 1500
            //   6a01                 | push                1
            //   56                   | push                esi
        ...
        $sequence_3 = { 8bec 51 56 57 ff7508 ff15???????? 8bf0 }
            // n = 7, score = 1500
            //   8bec                 | mov                 ebp, esp
            //   51                   | push                ecx
            //   56                   | push                esi
        ...
        $sequence_4 = { 50 ff91f0000000 85c0 7813 }
            // n = 4, score = 1500
            //   50                   | push                eax
        ...
        $sequence_7 = { a5 ff512c 85c0 756c }
            // n = 4, score = 1500
        ...
        $sequence_8 = { 6a00 8bf8 8d45fc 50 57 6a01 56 }
            // n = 7, score = 1500
            //   6a00                 | push                0
            //   8bf8                 | mov                 edi, eax
            //   8d45fc               | lea                 eax, dword ptr [ebp - 4]
