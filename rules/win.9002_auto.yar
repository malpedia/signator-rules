rule win_9002_auto {
    ...
    strings:
        $sequence_0 = { 8bd9 2bd8 85c0 7408 8bd1 2bd0 3bda }
            // n = 7, score = 200
            //   8bd9                 | mov                 ebx, ecx
            //   2bd8                 | sub                 ebx, eax
            //   85c0                 | test                eax, eax
        ...
        $sequence_1 = { 8b5d0c 6bdb08 03c3 8b00 5b }
            // n = 5, score = 200
        ...
        $sequence_2 = { 51 e8???????? 6a06 6a01 6a02 e8???????? }
            // n = 6, score = 200
            //   51                   | push                ecx
            //   e8????????           |                     
            //   6a06                 | push                6
        ...
        $sequence_4 = { 6a02 ff15???????? 68???????? ff15???????? 6a00 6a00 }
            // n = 6, score = 200
            //   6a02                 | push                2
            //   ff15????????         |                     
            //   68????????           |                     
        ...
        $sequence_5 = { 7424 682c010000 50 ffd3 }
            // n = 4, score = 200
            //   7424                 | je                  0x26
        ...
        $sequence_7 = { 68e8030000 ff15???????? 46 83fe1e }
            // n = 4, score = 200
        ...
        $sequence_8 = { 760d 85c0 7504 33ff eb05 8b7e08 }
            // n = 6, score = 200
            //   760d                 | jbe                 0xf
            //   85c0                 | test                eax, eax
            //   7504                 | jne                 6
        ...
        $sequence_9 = { 51 e8???????? 8b5714 83c404 }
            // n = 4, score = 200
            //   51                   | push                ecx
            //   e8????????           |                     
        ...
        $sequence_10 = { 8b00 5b ffd0 8945fc }
            // n = 4, score = 200
            //   8b00                 | mov                 eax, dword ptr [eax]
            //   5b                   | pop                 ebx
            //   ffd0                 | call                eax
        ...
        $sequence_12 = { 6a00 51 8944241c c744241801000000 ff15???????? 3d02010000 }
            // n = 6, score = 200
            //   6a00                 | push                0
            //   51                   | push                ecx
        ...
        $sequence_13 = { 8405???????? 755c 0905???????? 33c0 c705????????b0314000 a3???????? }
            // n = 6, score = 100
            //   8405????????         |                     
            //   755c                 | jne                 0x5e
            //   0905????????         |                     
        ...
        $sequence_14 = { 0311 8955fc 837df800 0f86e3000000 8b4508 03450c 2b45f8 }
            // n = 7, score = 100
        ...
        $sequence_16 = { 83c40c 8d4c2410 c744243800000000 ff15???????? }
            // n = 4, score = 100
            //   83c40c               | add                 esp, 0xc
        ...
        $sequence_18 = { 7516 8b460c 8b4e2c 2bc1 8b4e24 8bef }
            // n = 6, score = 100
            //   7516                 | jne                 0x18
        ...
        $sequence_19 = { 8bc6 5e c20400 b801000000 8405???????? 755c }
            // n = 6, score = 100
            //   8bc6                 | mov                 eax, esi
            //   5e                   | pop                 esi
            //   c20400               | ret                 4
        ...
        $sequence_20 = { 031481 52 8b450c 50 }
            // n = 4, score = 100
        ...
        $sequence_21 = { 83c020 50 ff15???????? c3 a1???????? 85c0 }
            // n = 6, score = 100
            //   83c020               | add                 eax, 0x20
            //   50                   | push                eax
            //   ff15????????         |                     
        ...
        $sequence_22 = { b810000000 2bd1 2bf1 8d9f04020000 89442414 c744241800010000 bf01000000 }
            // n = 7, score = 100
            //   b810000000           | mov                 eax, 0x10
            //   2bd1                 | sub                 edx, ecx
            //   2bf1                 | sub                 esi, ecx
            //   8d9f04020000         | lea                 ebx, dword ptr [edi + 0x204]
            //   89442414             | mov                 dword ptr [esp + 0x14], eax
            //   c744241800010000     | mov                 dword ptr [esp + 0x18], 0x100
            //   bf01000000           | mov                 edi, 1

        $sequence_23 = { 8b7c2414 8b6c2430 8a1411 88142f }
            // n = 4, score = 100
        ...
        $sequence_24 = { 03cd 33ed 81fa00000001 668b2c4b 7325 8b4c2428 8b5c2424 }
            // n = 7, score = 100
            //   03cd                 | add                 ecx, ebp
            //   33ed                 | xor                 ebp, ebp
        ...
        $sequence_25 = { 2bfa 66893c29 45 83ed40 }
            // n = 4, score = 100
            //   2bfa                 | sub                 edi, edx
        ...
        $sequence_26 = { 8a4704 3c0a 7404 3c0b }
            // n = 4, score = 100
        ...
        $sequence_28 = { 03c1 0f84a9000000 6683780200 0f869e000000 6a00 50 }
            // n = 6, score = 100
            //   03c1                 | add                 eax, ecx
