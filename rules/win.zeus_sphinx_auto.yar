rule win_zeus_sphinx_auto {
    ...
    strings:
        $sequence_0 = { 50 e8???????? 83c410 8b4744 897740 85c0 }
            // n = 6, score = 400
            //   50                   | push                eax
            //   e8????????           |                     
            //   83c410               | add                 esp, 0x10
        ...
        $sequence_1 = { 50 e8???????? 83c410 8b55c8 b801000000 85d2 }
            // n = 6, score = 400
            //   50                   | push                eax
            //   e8????????           |                     
            //   83c410               | add                 esp, 0x10
        ...
        $sequence_2 = { 50 e8???????? 83c410 8b475c c7474400000000 85c0 }
            // n = 6, score = 400
            //   50                   | push                eax
            //   e8????????           |                     
            //   83c410               | add                 esp, 0x10
        ...
        $sequence_3 = { 50 e8???????? 83c410 8b4738 c7041800000000 837dd800 7903 }
            // n = 7, score = 400
            //   50                   | push                eax
            //   e8????????           |                     
            //   83c410               | add                 esp, 0x10
        ...
        $sequence_4 = { 52 51 53 e8???????? 83c420 8d65f4 b801000000 }
            // n = 7, score = 400
            //   52                   | push                edx
            //   51                   | push                ecx
            //   53                   | push                ebx
        ...
        $sequence_5 = { 50 e8???????? 83c410 8b550c 8b4308 8b12 }
            // n = 6, score = 400
            //   50                   | push                eax
            //   e8????????           |                     
            //   83c410               | add                 esp, 0x10
        ...
        $sequence_6 = { 50 e8???????? 83c410 8b5508 8b02 85c0 }
            // n = 6, score = 400
            //   50                   | push                eax
            //   e8????????           |                     
            //   83c410               | add                 esp, 0x10
        ...
        $sequence_7 = { 50 e8???????? 83c410 8b5604 8d45ea 3b55a8 }
            // n = 6, score = 400
            //   50                   | push                eax
            //   e8????????           |                     
            //   83c410               | add                 esp, 0x10
            ...
            //   3b55a8               | cmp                 edx, dword ptr [ebp - 0x58]
        ...
        $sequence_10 = { 010c02 3bf7 0f85f0f50000 e9???????? }
            // n = 4, score = 100
