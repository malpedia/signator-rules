rule win_netwire_auto {
    ...
    strings:
        $sequence_0 = { e8???????? c7442408???????? c7442404???????? c70424???????? e8???????? c7442408???????? }
            // n = 6, score = 1200
            //   e8????????           |                     
            //   c7442408????????     |                     
            //   c7442404????????     |                     
        ...
        $sequence_1 = { c744241000000000 c744240c00000000 c744240800000000 c744240400000000 c7042408000000 e8???????? 83ec14 }
            // n = 7, score = 1200
        ...
        $sequence_2 = { e8???????? c704244a000000 e8???????? c7042446000000 e8???????? c7042449000000 }
            // n = 6, score = 1200
            //   e8????????           |                     
        ...
        $sequence_4 = { c744242c00000000 c744242800000000 c744242400000000 c7442420fdffffff c744241c00000000 c744241800000000 }
            // n = 6, score = 1200
        ...
        $sequence_5 = { c7042449000000 e8???????? c7042446000000 e8???????? }
            // n = 4, score = 1200
            //   c7042449000000       | mov                 dword ptr [esp], 0x49
            //   e8????????           |                     
            //   c7042446000000       | mov                 dword ptr [esp], 0x46
        ...
        $sequence_6 = { c744242800000000 c744242400000000 c7442420fdffffff c744241c00000000 c744241800000000 c744241400000000 c744241000000000 }
            // n = 7, score = 1200
            //   c744242800000000     | mov                 dword ptr [esp + 0x28], 0
            //   c744242400000000     | mov                 dword ptr [esp + 0x24], 0
            //   c7442420fdffffff     | mov                 dword ptr [esp + 0x20], 0xfffffffd
        ...
        $sequence_7 = { e8???????? c7042408000000 e8???????? 84c0 }
            // n = 4, score = 1200
            //   e8????????           |                     
            //   c7042408000000       | mov                 dword ptr [esp], 8
            //   e8????????           |                     
        ...
        $sequence_8 = { e8???????? a3???????? c7042440000000 e8???????? 84c0 }
            // n = 5, score = 1200
            //   e8????????           |                     
            //   a3????????           |                     
        ...
        $sequence_9 = { c705????????00000000 e9???????? c7042410020000 e8???????? }
            // n = 4, score = 1200
            //   c705????????00000000     |     
            //   e9????????           |                     
