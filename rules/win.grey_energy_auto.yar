rule win_grey_energy_auto {
    ...
    strings:
        $sequence_0 = { 53 6800000008 57 53 53 }
            // n = 5, score = 500
            //   53                   | push                ebx
        ...
        $sequence_1 = { e8???????? 68???????? 8945d4 e8???????? 68???????? 8945d0 }
            // n = 6, score = 500
            //   e8????????           |                     
            //   68????????           |                     
        ...
        $sequence_3 = { 7507 33c0 e9???????? c745f004000000 }
            // n = 4, score = 400
            //   7507                 | jne                 9
            //   33c0                 | xor                 eax, eax
            //   e9????????           |                     
        ...
        $sequence_7 = { 8b4d08 0fb70c41 8b45f0 33d2 }
            // n = 4, score = 400
        ...
        $sequence_9 = { 8b45ec 8b55f8 66890c42 eb14 8b45ec }
            // n = 5, score = 400
        ...
        $sequence_10 = { eb14 8b45ec 8b4df8 8b55f0 8b7508 }
            // n = 5, score = 400
            //   eb14                 | jmp                 0x16
            //   8b45ec               | mov                 eax, dword ptr [ebp - 0x14]
        ...
        $sequence_11 = { 8b55f0 8b7508 668b1456 66891441 }
            // n = 4, score = 400
            //   8b55f0               | mov                 edx, dword ptr [ebp - 0x10]
            //   8b7508               | mov                 esi, dword ptr [ebp + 8]
        ...
        $sequence_14 = { 03c0 50 57 ff7508 e8???????? 8b7df8 }
            // n = 6, score = 200
            //   03c0                 | add                 eax, eax
            //   50                   | push                eax
            //   57                   | push                edi
        ...
        $sequence_15 = { 7412 4f 0f8552ffffff 6a9c ff75a8 ff15???????? }
            // n = 6, score = 200
            //   7412                 | je                  0x14
            //   4f                   | dec                 edi
        ...
        $sequence_16 = { ff7508 ff7518 e8???????? 8b45f8 }
            // n = 4, score = 200
            //   ff7508               | push                dword ptr [ebp + 8]
