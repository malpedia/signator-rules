rule win_fancyfilter_auto {
    ...
    strings:
        ...
        $sequence_2 = { 85c0 750d 8b472c a801 }
            // n = 4, score = 400
            //   85c0                 | test                eax, eax
            //   750d                 | jne                 0xf
            //   8b472c               | mov                 eax, dword ptr [edi + 0x2c]
        ...
        $sequence_7 = { 85c0 740a 66833800 7404 b001 eb02 32c0 }
            // n = 7, score = 400
            //   85c0                 | test                eax, eax
            //   740a                 | je                  0xc
        ...
        $sequence_8 = { eb03 83c057 8801 49 }
            // n = 4, score = 400
            //   eb03                 | jmp                 5
            //   83c057               | add                 eax, 0x57
        ...
        $sequence_9 = { 750d 8b472c a801 7406 }
            // n = 4, score = 400
            //   750d                 | jne                 0xf
            //   8b472c               | mov                 eax, dword ptr [edi + 0x2c]
            //   a801                 | test                al, 1
