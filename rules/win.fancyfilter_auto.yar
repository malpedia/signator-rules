rule win_fancyfilter_auto {
    ...
    strings:
        $sequence_0 = { 8b472c a801 7406 83c804 }
            // n = 4, score = 400
        ...
        $sequence_1 = { 8b7604 6a00 56 ff15???????? }
            // n = 4, score = 400
        ...
        $sequence_2 = { 81e3ffffff00 ff15???????? 50 ff15???????? 85c0 }
            // n = 5, score = 400
        ...
        $sequence_3 = { 83c030 eb03 83c057 8801 49 }
            // n = 5, score = 400
            //   83c030               | add                 eax, 0x30
            //   eb03                 | jmp                 5
            //   83c057               | add                 eax, 0x57
        ...
        $sequence_5 = { 85c0 740a 66833800 7404 b001 eb02 32c0 }
            // n = 7, score = 400
            //   85c0                 | test                eax, eax
            //   740a                 | je                  0xc
        ...
        $sequence_6 = { b805400080 c20400 56 8b742408 }
            // n = 4, score = 400
        ...
        $sequence_7 = { 33f6 ff15???????? 83c414 83f803 }
            // n = 4, score = 400
            //   33f6                 | xor                 esi, esi
            //   ff15????????         |                     
            //   83c414               | add                 esp, 0x14
        ...
        $sequence_8 = { 33c0 0506010000 50 ff15???????? }
            // n = 4, score = 400
            //   33c0                 | xor                 eax, eax
        ...
        $sequence_9 = { ff15???????? 8b7604 6a00 56 ff15???????? }
            // n = 5, score = 400
            //   ff15????????         |                     
            //   8b7604               | mov                 esi, dword ptr [esi + 4]
            //   6a00                 | push                0
