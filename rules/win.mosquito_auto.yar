rule win_mosquito_auto {
    ...
    strings:
        ...
        $sequence_4 = { e8???????? 837f1408 89450c 7204 8b0f }
            // n = 5, score = 300
            //   e8????????           |                     
        ...
        $sequence_7 = { e8???????? 837f1408 8bd8 59 7202 8b3f ff7510 }
            // n = 7, score = 300
            //   e8????????           |                     
            //   837f1408             | cmp                 dword ptr [edi + 0x14], 8
            //   8bd8                 | mov                 ebx, eax
        ...
        $sequence_14 = { 6a00 ff15???????? 6a00 56 ff15???????? 8903 83f8ff }
            // n = 7, score = 200
            //   6a00                 | push                0
            //   ff15????????         |                     
            //   6a00                 | push                0
        ...
        $sequence_15 = { 728d 42 108b002e5e8b 0489 a3???????? }
            // n = 5, score = 200
            //   728d                 | jb                  0xffffff8f
            //   42                   | inc                 edx
            //   108b002e5e8b         | adc                 byte ptr [ebx - 0x74a1d200], cl
            //   0489                 | add                 al, 0x89
            //   a3????????           |                     
