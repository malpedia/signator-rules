rule win_mosquito_auto {
    ...
    strings:
        ...
        $sequence_5 = { 8d4508 50 c7450824000000 e8???????? }
            // n = 4, score = 300
        ...
        $sequence_7 = { 8d4508 50 c7450825000000 e8???????? }
            // n = 4, score = 300
            //   8d4508               | lea                 eax, [ebp + 8]
            //   50                   | push                eax
            //   c7450825000000       | mov                 dword ptr [ebp + 8], 0x25
            //   e8????????           |                     
        ...
        $sequence_10 = { e8???????? 6a20 8bd8 e8???????? 8bc8 }
            // n = 5, score = 200
            //   e8????????           |                     
            //   6a20                 | push                0x20
            //   8bd8                 | mov                 ebx, eax
        ...
        $sequence_11 = { 728d 45 670000 ff05???????? 5d }
            // n = 5, score = 200
            //   728d                 | jb                  0xffffff8f
            //   45                   | inc                 ebp
            //   670000               | add                 byte ptr [bx + si], al
            //   ff05????????         |                     
            //   5d                   | pop                 ebp
        ...
        $sequence_13 = { 0000 0001 1001 c550f0 8b8078005900 }
            // n = 5, score = 200
            //   0000                 | add                 byte ptr [eax], al
        ...
        $sequence_16 = { 0000 00748078 3001 40 }
            // n = 4, score = 200
            //   0000                 | add                 byte ptr [eax], al
        ...
        $sequence_18 = { 0000 006500 676c 0010 }
            // n = 4, score = 200
            //   0000                 | add                 byte ptr [eax], al
