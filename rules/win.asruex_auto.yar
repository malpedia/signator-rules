rule win_asruex_auto {
    ...
    strings:
        $sequence_0 = { 3c09 7408 3c0d 7404 3c0a 7516 }
            // n = 6, score = 300
            //   3c09                 | cmp                 al, 9
            //   7408                 | je                  0xa
            //   3c0d                 | cmp                 al, 0xd
        ...
        $sequence_1 = { 3c78 7404 3c58 7505 bb01000000 }
            // n = 5, score = 300
            //   3c78                 | cmp                 al, 0x78
            //   7404                 | je                  6
            //   3c58                 | cmp                 al, 0x58
        ...
        $sequence_4 = { e8???????? 83f8ff 7407 3d0000a000 }
            // n = 4, score = 300
            //   e8????????           |                     
            //   83f8ff               | cmp                 eax, -1
            //   7407                 | je                  9
        ...
        $sequence_6 = { 740c 3c09 7408 3c0d 7404 3c0a 7516 }
            // n = 7, score = 300
            //   740c                 | je                  0xe
            //   3c09                 | cmp                 al, 9
            //   7408                 | je                  0xa
        ...
        $sequence_9 = { ff15???????? 85c0 7407 3d14270000 }
            // n = 4, score = 300
            //   ff15????????         |                     
            //   85c0                 | test                eax, eax
            //   7407                 | je                  9
