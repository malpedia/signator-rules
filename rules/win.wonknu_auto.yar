rule win_wonknu_auto {
    ...
    strings:
        ...
        $sequence_1 = { b901050000 f3a5 8bcb e8???????? 803b00 }
            // n = 5, score = 200
            //   b901050000           | mov                 ecx, 0x501
            //   f3a5                 | rep movsd           dword ptr es:[edi], dword ptr [esi]
            //   8bcb                 | mov                 ecx, ebx
        ...
        $sequence_4 = { eb08 c6840550ffffff00 8d8550ffffff 50 }
            // n = 4, score = 200
            //   eb08                 | jmp                 0xa
        ...
        $sequence_7 = { e8???????? 8bfc b901050000 f3a5 8bcb e8???????? }
            // n = 6, score = 200
            //   e8????????           |                     
            //   8bfc                 | mov                 edi, esp
            //   b901050000           | mov                 ecx, 0x501
        ...
        $sequence_8 = { 8bfc b901050000 f3a5 8bcb e8???????? 803b00 }
            // n = 6, score = 200
            //   8bfc                 | mov                 edi, esp
            //   b901050000           | mov                 ecx, 0x501
            //   f3a5                 | rep movsd           dword ptr es:[edi], dword ptr [esi]
