rule win_wonknu_auto {
    ...
    strings:
        ...
        $sequence_3 = { b901050000 f3a5 8bcb e8???????? 803b00 }
            // n = 5, score = 200
        ...
        $sequence_4 = { 8bfc b901050000 f3a5 8bcb e8???????? 803b00 }
            // n = 6, score = 200
            //   8bfc                 | mov                 edi, esp
            //   b901050000           | mov                 ecx, 0x501
            //   f3a5                 | rep movsd           dword ptr es:[edi], dword ptr [esi]
        ...
        $sequence_5 = { 8d7e28 57 ff15???????? 8b4608 }
            // n = 4, score = 200
        ...
        $sequence_7 = { f3a5 8bcb e8???????? 803b00 }
            // n = 4, score = 200
            //   f3a5                 | rep movsd           dword ptr es:[edi], dword ptr [esi]
            //   8bcb                 | mov                 ecx, ebx
            //   e8????????           |                     
        ...
        $sequence_9 = { eb08 c6840550ffffff00 8d8550ffffff 50 }
            // n = 4, score = 200
            //   eb08                 | jmp                 0xa
            //   c6840550ffffff00     | mov                 byte ptr [ebp + eax - 0xb0], 0
            //   8d8550ffffff         | lea                 eax, [ebp - 0xb0]
