rule win_sombrat_auto {
    ...
    strings:
        $sequence_0 = { 750d 83c604 3bb7a0010000 75de eb15 8b4dfc }
            // n = 6, score = 300
            //   750d                 | jne                 0xf
            //   83c604               | add                 esi, 4
            //   3bb7a0010000         | cmp                 esi, dword ptr [edi + 0x1a0]
            //   75de                 | jne                 0xffffffe0
            //   eb15                 | jmp                 0x17
        ...
        $sequence_2 = { 01420c 8b11 294210 8b09 }
            // n = 4, score = 300
        ...
        $sequence_4 = { 0000 e8???????? c70424???????? 8d5f0c 68???????? }
            // n = 5, score = 300
        ...
        $sequence_5 = { 014114 014620 f6460c04 8945e0 742d }
            // n = 5, score = 300
        ...
        $sequence_6 = { 014114 8b7508 837df800 8b5df4 }
            // n = 4, score = 300
            //   014114               | add                 dword ptr [ecx + 0x14], eax
        ...
        $sequence_11 = { 016b08 488d05dc980500 41b9e7160000 4889442420 }
            // n = 4, score = 200
        ...
        $sequence_12 = { 015f08 83bfd800000016 0f856c020000 488b87c8000000 }
            // n = 4, score = 200
            //   015f08               | dec                 esp
        ...
        $sequence_13 = { 016b08 33c0 e9???????? 33ff }
            // n = 4, score = 200
            //   016b08               | xor                 eax, eax
            //   33c0                 | dec                 eax
            //   e9????????           |                     
