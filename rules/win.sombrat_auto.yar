rule win_sombrat_auto {
    ...
    strings:
        ...
        $sequence_4 = { 68???????? 8bcf e8???????? 84c0 7412 53 8bce }
            // n = 7, score = 300
            //   68????????           |                     
            //   8bcf                 | mov                 ecx, edi
            //   e8????????           |                     
        ...
        $sequence_5 = { 0145e4 8b55f8 83c40c 294644 }
            // n = 4, score = 300
        ...
        $sequence_6 = { 0000 e8???????? c70424???????? 8d5f0c 68???????? }
            // n = 5, score = 300
        ...
        $sequence_11 = { 016b08 33c0 e9???????? 33ff }
            // n = 4, score = 200
            //   016b08               | xor                 eax, eax
            //   33c0                 | dec                 eax
            //   e9????????           |                     
        ...
        $sequence_12 = { 01448c20 48ffc1 493bc9 7cf1 }
            // n = 4, score = 200
