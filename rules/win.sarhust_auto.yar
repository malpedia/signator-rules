rule win_sarhust_auto {
    ...
    meta:
        ...
        date = "2022-04-08"
        version = "1"
        description = "Describes win.sarhust."
    ...
    strings:
        ...
        $sequence_2 = { eb08 8b4520 8b4d0c 8908 }
            // n = 4, score = 200
            //   eb08                 | jmp                 0xa
        ...
        $sequence_5 = { 6801000080 ff15???????? 85c0 7408 ff15???????? }
            // n = 5, score = 200
        ...
        $sequence_6 = { 8d8d4cffffff e8???????? 8d8d4cffffff e8???????? 8d8d4cffffff e8???????? 6a00 }
            // n = 7, score = 200
            //   8d8d4cffffff         | lea                 ecx, dword ptr [ebp - 0xb4]
            //   e8????????           |                     
            //   8d8d4cffffff         | lea                 ecx, dword ptr [ebp - 0xb4]
        ...
        $sequence_8 = { 8d8d4cffffff e8???????? 8d8d4cffffff e8???????? 8d8d4cffffff e8???????? }
            // n = 6, score = 200
            //   8d8d4cffffff         | lea                 ecx, dword ptr [ebp - 0xb4]
            //   e8????????           |                     
            //   8d8d4cffffff         | lea                 ecx, dword ptr [ebp - 0xb4]
        ...
        $sequence_9 = { 8d8d4cffffff e8???????? 8d8d4cffffff e8???????? 6a00 }
            // n = 5, score = 200
            //   8d8d4cffffff         | lea                 ecx, dword ptr [ebp - 0xb4]
            //   e8????????           |                     
            //   8d8d4cffffff         | lea                 ecx, dword ptr [ebp - 0xb4]
