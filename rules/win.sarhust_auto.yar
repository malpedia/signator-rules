rule win_sarhust_auto {
    ...
    strings:
        ...
        $sequence_1 = { 8d8d4cffffff e8???????? 8d8d4cffffff e8???????? 8d8d4cffffff e8???????? 6a00 }
            // n = 7, score = 200
            //   8d8d4cffffff         | lea                 ecx, [ebp - 0xb4]
            //   e8????????           |                     
            //   8d8d4cffffff         | lea                 ecx, [ebp - 0xb4]
        ...
        $sequence_2 = { e8???????? 8d8d4cffffff e8???????? 6a00 ff15???????? }
            // n = 5, score = 200
            //   e8????????           |                     
            //   8d8d4cffffff         | lea                 ecx, [ebp - 0xb4]
            //   e8????????           |                     
        ...
        $sequence_3 = { 8d8d4cffffff e8???????? 6a00 ff15???????? }
            // n = 4, score = 200
            //   8d8d4cffffff         | lea                 ecx, [ebp - 0xb4]
            //   e8????????           |                     
            //   6a00                 | push                0
        ...
        $sequence_6 = { 8d8d4cffffff e8???????? 8d8d4cffffff e8???????? 6a00 }
            // n = 5, score = 200
            //   8d8d4cffffff         | lea                 ecx, [ebp - 0xb4]
            //   e8????????           |                     
            //   8d8d4cffffff         | lea                 ecx, [ebp - 0xb4]
