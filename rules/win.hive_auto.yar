rule win_hive_auto {
    ...
    strings:
        ...
        $sequence_2 = { b803000000 b9b6000000 31d2 31db }
            ...
            //   b9b6000000           | shl                 edx, 6
            //   31d2                 | movzx               eax, bl
            //   31db                 | add                 eax, edx

        $sequence_3 = { b804000000 b9df000000 31d2 31db }
            // n = 4, score = 300
            //   b804000000           | shl                 eax, 6
            //   b9df000000           | inc                 eax
            //   31d2                 | movzx               ecx, bh
            //   31db                 | add                 ecx, eax

        $sequence_4 = { b918000000 e8???????? 89d0 b918000000 e8???????? }
            // n = 5, score = 300
            //   b918000000           | inc                 eax
            //   e8????????           |                     
            //   89d0                 | movzx               edx, dh
            //   b918000000           | add                 eax, ecx
            //   e8????????           |                     
        ...
        $sequence_11 = { 01ca c1e206 0fb6c3 01d0 }
            // n = 4, score = 100
            //   01ca                 | mov                 ecx, eax
            //   c1e206               | shr                 ecx, 0x1f
            //   0fb6c3               | dec                 ecx
